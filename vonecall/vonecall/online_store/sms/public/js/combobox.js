...
ComboBox = function (object_name) {
	...
	parobject.dropdownlist.onblur = function () {
	...
	function check(e){
		...
		var obj = parobject.dropdownlist;
		var obj3 = pick[0];
		var obj2 = parobject.edit;
	...
	parobject.edit.value="Please Select";
