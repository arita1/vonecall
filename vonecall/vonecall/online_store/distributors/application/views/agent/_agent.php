        ...
        <tr>
          <td width="170" valign="top"class="col_left" ><div class="nav_left">
            <ul>
              ...
              <li <?php if($sub_current_page=='payment') echo 'class="current"';?>><a href="<?php echo site_url('store/payment/'.$agentID);?>">Make Payment</a></li>
              <!--
              <li <?php if($sub_current_page=='balance_report') echo 'class="current"';?>><a href="<?php echo site_url('store/balance-report/'.$agentID);?>">Store Balance Report</a></li>
              <li <?php if($sub_current_page=='sale_query') echo 'class="current"';?>><a href="<?php echo site_url('store/sale-query/'.$agentID);?>">Store Sale Query</a></li>
              -->
            </ul>
          </div></td>
          ...
          <?php if (isset($warning)) {?><br/><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
              ...
              <div class="box_submenu p12t p13b">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr class="boder_top">
                    <!--
                    <td width="20%" class="boder_right boder_top">
                      Time Period: <?php echo form_dropdown('time_period', $option_time_period, 'today', 'class="" onchange="calculate_agent(this.value);"');?>
                      
                      Sales Summary
                    </td>
                    -->
                    <td class="boder_right boder_top">Current Balance: <span class="ogr_color"><strong><?php echo format_price($info->balance);?></strong></span></td>
                    <td class="boder_right boder_top">Total Sale: <span class="ogr_color"><strong id="agent_sale"><?php echo $info->TotalSale;?></strong></span></td>
                    <td class="boder_right boder_top">Total Payment: <span class="ogr_color"><strong id="agent_payment"><?php echo $info->TotalPayment;?></strong></span></td>
                    <td class="boder_right boder_top">Total Commission: <span class="ogr_color"><strong id="agent_commission"><?php echo $info->TotalCommission;?></strong></span></td>
                  </tr>
                </table>
              </div>
