...
<div class="form_addcustomer p15t">
  ...
  <?php echo form_open_multipart(site_url('store/payment/'.$agentID), array('id'=>'make_payment', 'name'=>'make_payment'))?>
  <table border="0" align="left" cellpadding="0" cellspacing="0" class="font8">
    ...
    <!--<tr>
      <td width="35%">Payment Method<font color=red>*</font></td>
      <td width="65%">
        <?php echo form_dropdown('payment_type', $option_payment_type, (isset($payment_type)?$payment_type:''), 'class="w327" onchange="change_payment_type(this.value);"');?>
        <?php if (isset($error['payment_type'])) {?><span class="red_color"><?php echo $error['payment_type'];?></span><?php }?>
      </td>
    </tr>-->
    <tr>
    ...
    <tr id="tr_card_name" class="newCard">
      <td>Name on Credit Card<font color=red>*</font></td>
      <td>
