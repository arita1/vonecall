...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="font8">
  ...
  <tr>
    ...
    <td width="905">
    	<input name="storeName" value="<?php echo isset($storeName)?$storeName:'';?>" type="text" class="w325" />
  ...
  <tr>
    <td>Password</td>
    <td>
    	<input type="text" name="password" value="" placeholder="<?php echo isset($password)?$password:'';?>" class="w325" />
