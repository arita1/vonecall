...
<body style="background: none; min-width: 100%;">
<div class="p10b" id="main" style="padding-top: 0; min-width: 979px;">
  ...
  <div class="center_page_afterlogin" style="border-left: 1px solid #B3D7E0; border-right: 1px solid #B3D7E0; border-bottom: 1px solid #B3D7E0; padding-bottom: 15px;">
      ...
      <div class="box_rate p10l p10r p10t">
        <div class="box_quicksearch" style="padding-left: 5px;">
          <?php echo form_open_multipart(site_url('popup-rate'), array('id'=>'rate_form', 'name'=>'rate_form'));?>
            ...
            <tbody>
              <tr>
                ...
                <td width="24%"><?php echo form_dropdown('balance', $option_balance, (isset($balance)?$balance:''), 'class="w132"');?></td>
     	        <td width="15%"><a class="bt_save m10b" href="javascript:void(0);" onclick="$('#rate_form').submit();">Search</a></td>
              </tr>
            </tbody>
          </table>
          <?php echo form_close();?>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tbody>
            <tr class="bg_table">
              <td width="25%" class="boder_right"><strong>Country</strong></td>
              <td width="25%" class="boder_right"><strong>City-Description</strong></td>
              <td width="25%" align="right" class="boder_right"><strong>Rate/Min</strong></td>
            </tr>
