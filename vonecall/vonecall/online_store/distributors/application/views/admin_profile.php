...
<div id="main">
	<div class="bg_title_content">
		Your Current Balance:  <span style="color: #6F9C01; font-size: 16px;"><?php echo format_price($balance)?></span> 
	</div>
	<div class="bg_title_content">My Profile</div>
		<div class="form_addcustomer p15t">
		  <?php if (isset($message)) {?><dl id="system-message"><dd class="message"><ul><li><?php echo $message;?></li></ul></dd></dl><?php }?>
		  <?php if (isset($warning)) {?><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
		  <?php echo form_open_multipart(site_url('profile'), array('id'=>'form_distributor', 'name'=>'form_distributor'))?>
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="font8">
		    ...
		    <tr>
		      <td width="319">Your Current Balance</td>
		      <td width="905">
		    ...
		    <tr>
		      ...
		      <td width="905">
		        <input name="company_name" readonly="readonly" value="<?php echo isset($company_name)?$company_name:'';?>" class="w325" type="text" />
		    ...
		    <tr>
		      ...
		      <td width="905">
		        <input name="firstName" readonly="readonly" value="<?php echo isset($firstName)?$firstName:'';?>" type="text" class="w325" />
		    ...
		    <tr>
		      ...
		      <td>
		        <input type="text" name="lastName" readonly="readonly" value="<?php echo isset($lastName)?$lastName:'';?>" class="w325" />
		    ...
		    <tr>
		      <td>Address</td>
		      <td>
		        <input name="address" readonly="readonly" value="<?php echo isset($address)?$address:'';?>" class="w325" type="text" />
		    ...
		    <tr>
		      <td>Address 2</td>
		      <td>
		        <input name="address2" readonly="readonly" value="<?php echo isset($address2)?$address2:'';?>" class="w325" type="text" />
		    ...
		    <tr>
		      <td>City</td>
		      <td>
		        <input name="city" readonly="readonly" value="<?php echo isset($city)?$city:'';?>" class="w325" type="text" />
		    ...
		    <tr>
		      <td>Zip</td>
		      <td>
		        <input name="zip" readonly="readonly" value="<?php echo isset($zip)?$zip:'';?>" class="w325" type="text" />
		    ...
		    <tr>
		      ...
		      <td>
		        <input type="text" name="phone" readonly="readonly" value="<?php echo isset($phone)?$phone:'';?>" class="w325" />
		    ...
		    <tr>
		      ...
		      <td>
		        <input name="cellphone" readonly="readonly" value="<?php echo isset($cellphone)?$cellphone:'';?>" class="w325" type="text" />
		    ...
		    <tr>
		      ...
		      <td>
		        <input type="text" name="email" readonly="readonly" value="<?php echo isset($email)?$email:'';?>" class="w325" />
