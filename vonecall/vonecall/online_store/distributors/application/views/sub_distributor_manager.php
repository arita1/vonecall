...
<div id="main" class="mh730">
      <div class="bg_title"> Sub-Distributor Management </div>
      <div class="p20l p20r p13b">
        ...
        <div class="form_addcustomer p15t">
          ...
          <?php echo form_open_multipart(site_url('sub-distributor-account-manager'), array('id'=>'account_dist_manager', 'name'=>'account_dist_manager'));?>
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>Search by Sub-distributor Code</td>
              <td>Search by Sub-distributor Login ID</td>
              <td>Search by Sub-distributor Last Name</td>
              <td>Search by Sub-distributor Email</td>
            </tr>
            <tr>
        ...
        <p class="p10 bo_t_d m10t">
          ...
          <a class="bt_atatement_address" onclick="rep_search('search_by_all');">View All Sub-distributor</a>
          <a class="bt_atatement_address" href="<?php echo site_url('add-new-distributor')?>" >Add Sub-distributor</a>
        </p>
        <div class="box_phonenumber p12t p13b">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="<?php echo($i%2==1)?'':'bg_light_blu';?>">
              ...
              <td class="boder_right"><a href="<?php echo site_url('distributor/profile/'.$item->agentID);?>"><strong><?php echo $item->loginID;?></strong></a></td>
...
function delete_rep(id) {
	if (confirm("Are you sure want to delete this destributor?")) {
		$.ajax({
			url: '<?php echo site_url('delete-distributor');?>',
			type: 'POST',
			cache: false,
			data:{id:id},
			dataType: "json",
