...
<div class="p10b" id="main" style="padding-top: 0;width: 979px;">
  <div class="bg_tt_page"><div class="ac">Access Number</div></div>
  <div class="center_page_afterlogin" style="border-left: 1px solid #B3D7E0; border-right: 1px solid #B3D7E0; border-bottom: 1px solid #B3D7E0; padding-bottom: 15px;">
    <div class="box_phonenumber p10l p10r p10t">
		...
		<!-- Add table with Datatables 28_Feb -->
		  <table id="accessnumber_table" width="100%" border="0" cellspacing="0" cellpadding="0" style="float: left;margin-top: 5px;">
			<thead>
			<tr class="bg_table" style="text-align: center;">
			  <th style="padding: 7px 10px;" class="bg_table boder_right"><strong><?php echo $this->lang->line('state');?></strong> </th>
			  <th class="bg_table boder_right"><strong><?php echo $this->lang->line('city');?></strong></th>
			  <th class="bg_table boder_right"><strong>Access Number </strong></th>
			</tr>
			</thead>
			<tbody>
