...
<div id="main">
      <div class="bg_title">Sub-distributor manager</div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="170" valign="top"class="col_left" ><div class="nav_left">
            <ul>
              <li <?php if($sub_current_page=='profile') echo 'class="current"';?>><a href="<?php echo site_url('distributor/profile/'.$agentID);?>"> Profile</a></li>              
            </ul>
          </div></td>
          ...
          <?php if (isset($warning)) {?><br/><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
              <div class="bg_title_content2">Sub-distributor Information</div>
