				    ...
				    <?php if (isset($warning)) {?><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
				      <div class="col_big">
				        ...
				        <div class="box_makepayment ">        	
				            <div class="cb"></div>
				            <?php echo form_open_multipart(site_url('vonecall-speed-dails/'.$phone), array('id'=>'speed_dial_form', 'name'=>'speed_dial_form'));?>
				        ...
				        <div class="loading"> <img src="<?php echo $this->config->item('base_url')?>public/images/loading_new.gif" /> </div>
				        <!-- Records -->
				       <!-----aaaa-------- <div class="box_phonenumber p10l p10r p10t">
					        <table width="100%" cellspacing="0" cellpadding="0" border="0">
					          <tbody>
					            <tr class="bg_table">
					              <td width="5%" align="left" class="boder_right"><strong>ID</strong></td>
			...
			<div class="col-md-12">
				<div class="panel panel-success access-table">
					<div class="panel-heading">
						<h3 class="panel-title">Speed Dials</h3>
