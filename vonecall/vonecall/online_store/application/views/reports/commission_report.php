...
<div id="main" class="p5t p10b">
  <div class="bg_tt_page"><div class="ac">Commission Report</div></div>
  <div class="center_page_afterlogin">
    ...
    <div class="col_big">
        ...
        <a class="bt_submit4 float_left m10l" href="javascript:void(0);" onclick="$('#commission_report').submit();"><?php echo $this->lang->line('submit');?></a>
        <br class="cb">    
        <?php echo form_close();?>
      </div>
      ...
      <div class="box_phonenumber p10l p10r p10t">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tbody>
            <tr class="bg_table">
              <td width="20%" align="left" class="boder_right"> <strong>Transaction Date</strong></td>
              <!--<td width="12%" align="right" class="boder_right"><strong>Source</strong></td>-->
              <td width="12%" align="left" class="boder_right"><strong>Product</strong></td>
              <td width="12%" align="left" class="boder_right"><strong>Product Type</strong></td>
              <td width="12%" align="left" class="boder_right"><strong>Trans Type</strong></td>
              <td width="12%" align="left" class="boder_right"><strong>Sale</strong></td>
              <td width="12%" align="left" class="boder_right"><strong>Commission</strong></td>
            </tr>
            ...
            <tr class="<?php echo($i%2==1)?'':'bg_light_blu';?>">
              ...
              <!--<td align="right" class="boder_right"><?php echo $item->agentTypeName?></td>-->
              <td align="right" class="boder_right"><?php echo $item->vproductName?></td>
              <td align="right" class="boder_right"><?php echo $productType?></td>
