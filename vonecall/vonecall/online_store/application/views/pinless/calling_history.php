<style>
  ...
  <div class="bg_tt_page"><div class="ac">Calling History</div></div>
    ...
    <?php if (isset($warning)) {?><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
      <div class="col_big">
        ...
        <div class="box_makepayment ">        	
            <div class="cb"></div>
            <?php echo form_open_multipart(site_url('calling-history/'.$phone), array('id'=>'transaction_form', 'name'=>'transaction_form'));?>
