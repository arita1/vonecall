...
<div id="main" class="p5t p10b">
  <div class="bg_tt_page"><div class="ac">Pinless Calling History</div></div>
  <div class="center_page_afterlogin">
    ...
    <div class="col_big">
      ...
      <div class="box_makepayment ">        	
        <div class="cb"></div>
        <?php echo form_open_multipart(site_url('pinless-call-history/'), array('id'=>'transaction_form', 'name'=>'transaction_form'));?>
        ...
        <label class="label1">Phone Number<span class="red_color">*</span></label>
