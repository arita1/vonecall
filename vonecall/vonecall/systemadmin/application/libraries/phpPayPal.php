...
//	if($sandbox):
		...
		private $API_USERNAME = 'paypro_1321597289_biz_api1.loginvn.com';
		private $API_PASSWORD = '1321597327';
		private $API_SIGNATURE = 'AiPC9BjkCyDFQXbSkoZcgqH3hpacAQZYK-iurJchvGM-eWhyB3auHOW8';
...
//		echo "</pre>";
	...
	function set_express_checkout1()
	{
		// TODO: Add error handling prior to trying to make PayPal calls. ie: missing amount_total or RETURN_URL
	...
	function get_express_checkout_details()
	{
		...
		$nvpstr = $this->generateNVPString('GetExpressCheckoutDetails');
		 ...
		 /* Make the API call and store the results in an array.  If the
			...
			*/
		$this->Response = $this->hash_call("GetExpressCheckoutDetails", $nvpstr);//print_r($this->Response);die;
