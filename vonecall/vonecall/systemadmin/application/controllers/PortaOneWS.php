...
class PortaOneWS
{
	...
	#get_customer_info
	public function getCustInfo($params, $sessionID){
		$this->sessionID = $sessionID;
		$response = $this->_handleQuery('get_customer_info', $params);
	...
	## get Product List
	public function get_product_list($params, $sessionID){
		$this->sessionID = $sessionID;
		$response = $this->_handleQuery('get_product_list', $params);
