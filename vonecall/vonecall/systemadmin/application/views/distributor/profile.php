<div class="bg_title_content">Update Distributor Information</div>
<div class="form_addcustomer p15t">
  <?php if (isset($message)) {?><dl id="system-message"><dd class="message"><ul><li><?php echo $message;?></li></ul></dd></dl><?php }?>
  <?php if (isset($warning)) {?><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
  <?php echo form_open_multipart(site_url('destributor/profile/'.$agentID), array('id'=>'form_destributor', 'name'=>'form_destributor'))?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="font8">
    ...
    <tr>
      <td>Password</td>
      <td>
    	<input type="text" name="password" value="" class="w325" placeholder="<?php echo isset($password)?$password:'';?>" />
    	<?php if (isset($error['password'])) {?><span class="red_color"><?php echo $error['password'];?></span><?php }?>
      </td>
    </tr>   
    <tr>
      <td>&nbsp;</td>
      <td><a class="bt_save" href="javascript:void(0);" onclick="$('#form_destributor').submit();">Update</a></td>
    </tr>
  </table>
  <?php echo form_close();?>
</div>