  ...
  <div class="p20l p20r p13b">
    ...
    <div class="box_phonenumber p12t p13b">     
      ...
      <div class="form_addcustomer p15t">
        <?php echo form_open_multipart(site_url('add-new-admin'), array('id'=>'add_new_admin', 'name'=>'add_new_admin'));?>
        ...
        <input name="password" value="<?php echo isset($password)?$password:'';?>" class="w325" type="text" />
        ...
        <label>&nbsp;</label>
        <a class="bt_save float_left" href="javascript:void(0);" onclick="$('#submit_type').val(1);$('#add_new_admin').submit();">Submit</a>
        <div class="cb"></div>
        <?php echo form_close();?>
      </div>
    </div>
