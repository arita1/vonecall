...
<div id="main">
  <div class="bg_title_content">Store Payment Report</div>
  <div class="p20l p20r p13b">
    <div class="form_addcustomer p12t p5b">
      <?php echo form_open_multipart(site_url('reports/store-payment'), array('id'=>'store_payment', 'name'=>'store_payment'));?>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
        	<td colspan="4"><a class="bt_atatement_address" href="javascript:void(0);" onclick="submit_detail('date');" style="margin-bottom: 7px;">Search</a></td>
        </tr>
      </table>
      <?php echo form_close();?>
    </div>
...
<?php if (isset($results)) { ?>    
    <div class="box_phonenumber p12t p13b">
      <div class="p5t p5b" style="font-weight:bold;">Store Payments</div>
