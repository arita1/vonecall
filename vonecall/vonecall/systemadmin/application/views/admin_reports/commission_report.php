...
<div id="main">
  ...
  <div class="p20l p20r p13b">
    <div class="form_addcustomer p12t p5b">
      <?php echo form_open_multipart(site_url('reports/commission-report'), array('id'=>'commission_report', 'name'=>'commission_report'));?>
    ...
    <div class="box_phonenumber p12t p13b">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr class="white_color">
          ...
          <td align="right" class="bg_table boder_right">Product Name</td>
          <td align="right" class="bg_table boder_right">Charged Amount</td>          
          <td align="right" class="bg_table">Admin Commission</td>
        </tr>
        ...
        <?php $i=1;$totalAmount=0;$totalStoreCommission=0;$totalDistCommission=0; $totalAdminCommission=0;?>
	        ...
	        <tr class="<?php echo($i%2==1)?'':'bg_light_blu';?>">
	          ...
	          <td align="right" ><?php echo format_price($item->adminCommission);?></td>
	        </tr>
