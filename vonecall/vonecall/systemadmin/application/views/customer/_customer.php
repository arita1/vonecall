      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="170" valign="top"class="col_left" ><div class="nav_left">
            <ul>
              <li <?php if($sub_current_page=='profile') echo 'class="current"';?>><a href="<?php echo site_url('customer/profile/'.$customerID);?>">Customer Profile </a></li>              
            </ul>
          </div></td>
          ...
          <?php if (isset($warning)) {?><br/><dl id="system-message"><dd class="message error"><ul><li><?php echo $warning;?></li></ul></dd></dl><?php }?>
              <div class="bg_title_content2">Customer Information</div>
              <div class="box_submenu p12t p13b">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="20%" class="boder_right">Phone Number: <?php echo format_phone_number($info->phone);?></td>                    
                  </tr>
                </table>
              </div>
