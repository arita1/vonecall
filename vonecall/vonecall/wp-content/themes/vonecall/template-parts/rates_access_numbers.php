<?php
/* Template Name: Rates-Access-number */
...
<div id="desh-bord">
        ...
        <div class="col-md-12" style="clear: both;">
          <div class="desh-bg">
            <div class="row">
              <div class="col-md-12">
                <div class="title">
                  <h4 >RATES AND ACCESS NUMBERS </h4>
                </div>
              </div>
            </div>
            <div class="row">
 ...
 <div class="col-md-1 col-sm-2">
              <h4 class="table-label">Country</h4>
              </div>
                     ...
                     <div class="col-md-1 col-sm-2">
              <h4 class="table-label">Balance</h4>
              </div>
                      <div class="col-md-4 col-sm-3">
          ...
          <img src="<?php echo WP_SITEURL.'/wp-content/uploads/loader.gif'?>">
		    ...
		    <div class="">
                  ...
                  <div id="searched_data" style="display:none">
                  <div class="row" >
